...
abstract class BaseRadioterapiaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'rodzaj_radioterapii_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('RodzajRadioterapii'), 'column' => 'id')),
    ));
  ...
  public function getFields()
  {
    return array(
      ...
      'rodzaj_radioterapii_id' => 'ForeignKey',
    );
  }
}
